...
public class ObjectFactory {
    ...
    public JAXBElement<EditorGroupImpl> createSeriesHeader(EditorGroupImpl value) {
        return new JAXBElement<EditorGroupImpl>(_SeriesHeader_QNAME, EditorGroupImpl.class, null, value);
    }
