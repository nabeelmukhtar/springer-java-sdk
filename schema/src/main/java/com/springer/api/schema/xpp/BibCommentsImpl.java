...
/**
 * The Class BibCommentsImpl.
 */
public class BibCommentsImpl extends BaseSchemaEntity implements BibComments {
    ...
    /* (non-Javadoc)
     * @see com.springer.api.schema.BibComments#getContent()
     */
