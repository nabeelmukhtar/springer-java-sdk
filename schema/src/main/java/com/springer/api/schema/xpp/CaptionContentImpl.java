...
/**
 * The Class CaptionContentImpl.
 */
public class CaptionContentImpl extends BaseSchemaEntity implements CaptionContent {
    ...
    /* (non-Javadoc)
     * @see com.springer.api.schema.CaptionContent#getSimplePara()
     */
    ...
    /* (non-Javadoc)
     * @see com.springer.api.schema.CaptionContent#setSimplePara(com.springer.api.schema.SimplePara)
     */
